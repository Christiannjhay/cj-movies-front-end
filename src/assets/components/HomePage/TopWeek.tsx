        ...
        >
          <div className="flex h-20 bg-[#0F0F0F] rounded-2xl overflow-hidden hover:bg-red-500 transition duration-300 ease-in-out group">
            <div className="absolute">
              <div>
                <h1 className="absolute top-10 left-0 flex items-center justify-center w-8 h-8 bg-[#0F0F0F] rounded-full text-red-500 group-hover:bg-red-500 font-bold text-lg transform -translate-x-1/2 -translate-y-1/2 group-hover:text-white transition-colors duration-300 border-2 border-red-500">
                  {index + 1}
                </h1>
              </div>
            </div>
